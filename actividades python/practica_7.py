...
if opcion == "1":  
    ...
    # Muestra mensaje de comprobación de disco
elif opcion == "2":  
    # Si elige la opción 2
    print("Comprobando memoria RAM...")  
    # Muestra mensaje de comprobación de RAM
elif opcion == "3":  
    # Si elige la opción 3
    print("Comprobando temperatura...")  
    # Muestra mensaje de comprobación de temperatura
elif opcion == "4":  
    ...
    # Muestra que la opción no es válida
